...
return ( <FadeIn> <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black text-white px-6">
...
```
    ...
    <div className="absolute inset-0">
      <Image
        src="/images/hero.jpg"
        alt="Pearl of Africa Systems technology"
        fill
        priority
    ...
    <div className="relative z-10 max-w-6xl mx-auto text-center">
      ...
      >
        ...
        cybersecurity, AI systems, cloud infrastructure and enterprise
        technology.
      </motion.p>
      ...
      >
        <a
          href="#contact"
          className="bg-green-500 hover:bg-green-600 hover:scale-105 active:scale-95 transition duration-300 px-8 py-4 rounded-2xl text-lg font-semibold shadow-lg shadow-green-500/20"
        >
          Get Started
        </a>
        ...
        <a
          href="#services"
          className="border border-white hover:bg-white hover:text-black hover:scale-105 active:scale-95 transition duration-300 px-8 py-4 rounded-2xl text-lg font-semibold"
        >
          Our Services
        </a>
      </motion.div>
